...
|:------|:------|:----------------|:-----------------------|:--------------------------------------------------------------------------------------------|:------------------|:-------------------|:-------|
| 1 — Accounts | Yoko Mohr | yokocsumb | #2, #3, #5, #6, #8 #14 | yoko/javafx_app, yoko/SQLite_database_structure, yoko/database-singleton, yoko/login-fxml, yoko/account-fxml-crud | #4, #12, #15, #19 |Notifications / alerts on app events   | in-progress |
