...
|:------|:------|:----------------|:-----------------------|:--------------------------------------------------|:--------|:-------------------|:-------|
| 1 — Accounts | Yoko Mohr | yokocsumb | #2, #3, #5, #6, #8 #14 | yoko/javafx_app, yoko/SQLite_database_structure, yoko/database_feature01 | #4, #12 |Notifications / alerts on app events   | in-progress |
