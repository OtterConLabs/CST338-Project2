...
|---|---|---|---|------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|---|---|
| 1 — Accounts | Yoko Mohr | yokocsumb | #2, #3, #5, #6, #8, #14, #30, #37, #41 | yoko/javafx_app, yoko/SQLite_database_structure, yoko/database-singleton, yoko/login-fxml, yoko/account-fxml-crud, yoko/FXML-dashboard-setup, yoko/test-UserDao,yoko/account-feature | #4, #12, #15, #19, #20, #31, #39, #42, #46 | Notifications / alerts on app events | in-progress |
...
| #PR | Yoko Mohr | REVIEWER_NAME | PR Link          | 3 accepted, 1 partially accepted, 1 rejected  |
